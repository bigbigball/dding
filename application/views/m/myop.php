...
<body class="mobile">
  ...
  <div class="container">
    <div class="main">
      <div class="content">
        <div class="title">
          <h4>丁盯门磁</h4>
          <a href="<?php echo base_url() ?>index.php/pc/opinion/myopmf" class="btn btn-b">编 辑</a>
        </div>
        <div class="comment">
          <div class="bannerbar">
            <div class="banner">
              <div class="item" >
                <img src="<?php echo base_url() ?><?php if(isset($pictures[0])) echo $pictures[0]; else echo "static/images/temp/p_1.png";?>" />
              </div>
              <div class="item">
                <img src="<?php echo base_url() ?><?php if(isset($pictures[1])) echo $pictures[1]; else echo "static/images/temp/p_1.png";?>" />
              </div>
              <div class="item">
                <img src="<?php echo base_url() ?><?php if(isset($pictures[2])) echo $pictures[2]; else echo "static/images/temp/p_1.png";?>" />
              </div>
              <div class="item">
                <img src="<?php echo base_url() ?><?php if(isset($pictures[3])) echo $pictures[3]; else echo "static/images/temp/p_1.png";?>" />
              </div>
              <div class="item">
                <img src="<?php echo base_url() ?><?php if(isset($pictures[4])) echo $pictures[4]; else echo "static/images/temp/p_1.png";?>" />
              </div>
              <div class="temp"></div>
              <ul class="switch">
        ...
        <div class="talk">
          ...
          <?php foreach($comments as $comment){?>
            <li class="li-icon">
              ...
              <p class="btn_p">
                <a class="btn btn-c" style="right:30%;<?php if(isset($info['id']) && isset($user_id) && $info['id'] == $user_id){} 
                else if(isset($comment['owner_id']) && $comment['owner_id'] != $user_id) echo "display: none;";?>" 
                onclick="delcommet('<?php echo base_url()?>index.php/pc/opinion/delcom', <?php if(isset($comment['id'])) echo $comment['id'];?>)">删除</a>
              ...
              <p class="area_p" style="display:;">
                ...
                <span class="answer"><img src="images/talk_up.png" /></span>
                <a class="btn btn-a" onClick="sendReply(this)">发布</a>
              </p>
            </li>
            <?php }?>
		</ul>
  ...
  function replyOther(self){
    jQuery(jQuery(self).parent().siblings()[3]).css('display','block');
  }
