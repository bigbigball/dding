...
<body>
  <div class="header">
    <div class="container">
      ...
      <a href="<?php echo base_url() ?>opinion/personal" <?php if(isset($user_id) && !$user_id) echo "style='display:none'";?> class="btn">
        <img src="<?php echo base_url() ?><?php if(isset($myinfo['photo'])) echo $myinfo['photo'];?>" />
      </a>
  ...
  <div class="container">
    <div class="main">
      <div class="location">
        <span>
        <a href="<?php echo base_url() ?>opinion">观点 </a>
        <i></i>丁盯门磁 
        </span>
      </div>
      <div class="content">
        <div class="title">
          <h4>丁盯门磁</h4>
          <a href="<?php echo base_url() ?>opinion/myopmf" class="btn btn-b" 
        ...
        <div class="talk" >
          <h5>谈谈你的观点呢</h5>
          <form action="<?php echo site_url('opinion/comment') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return checkInputBeforeSubmit(this);">
