		...
		<div class="container">
			<div class="mpinfo">
				<p>
					...
					<span><?php if(isset($info['user_name']) && $info['user_name']) echo $info['user_name']; else echo $info['mobile']?>的门磁观点</span>
				</p>
			</div>
			<div class="main">
				<div class="content">
					...
					<div class="comment">
						<div class="bannerbar">
							<div class="banner">
								<div class="item">
									<img
										src="<?php echo base_url() ?><?php if(isset($pictures[0]) && $pictures[0]) echo $pictures[0]; else echo "static/images/temp/p_1.png";?>" height="48" width="48"/>
								</div>
								<div class="item">
									<img
										src="<?php echo base_url() ?><?php if(isset($pictures[1]) && $pictures[1]) echo $pictures[1]; else echo "static/images/temp/p_1.png";?>" height="48" width="48"/>
								</div>
								<div class="item">
									<img
										src="<?php echo base_url() ?><?php if(isset($pictures[2]) && $pictures[2]) echo $pictures[2]; else echo "static/images/temp/p_1.png";?>" height="48" width="48"/>
								</div>
								<div class="item">
									<img
										src="<?php echo base_url() ?><?php if(isset($pictures[3]) && $pictures[3]) echo $pictures[3]; else echo "static/images/temp/p_1.png";?>" height="48" width="48"/>
								</div>
								<div class="item">
									<img
										src="<?php echo base_url() ?><?php if(isset($pictures[4]) && $pictures[4]) echo $pictures[4]; else echo "static/images/temp/p_1.png";?>" height="48" width="48"/>
								</div>
								<div class="temp"></div>
								<ul class="switch">
						...
						<?php foreach($comments as $comment){?>
							<li class="li-icon">
								...
								<p class="btn_p">
									...
									<?php if(isset($info['id']) && isset($user_id) && $info['id'] == $user_id){} 
				...
				<div class="content">
					<div class="pcintro">
						<p class="avatar" style="top: -3em;">
							<img
								src="<?php echo base_url() ?><?php if(isset($info['photo'])) echo $info['photo'];?>" />
						</p>
