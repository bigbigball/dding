<!DOCTYPE html>
<html id="{%block name='html_id'%}doc{%/block%}" class="{%block name='html_class'%}{%/block%}">
<head>
	<meta charset="UTF-8">
	<title>{%block name="page_title"%}丁盯智能门磁 - 云丁网络技术（北京）有限公司{%/block%}</title>
...
<body id="{%block name='body_id'%}{%/block%}" class=" {%block name='body_class'%}{%/block%}">
	<!--[if IE ]>
...
<script type="text/javascript" src=/static/pc/js/lib/require-75e6d0132deb386b88774eb44091150d.js></script>
<script type="text/javascript">
require.config({
